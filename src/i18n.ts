...
/**
 * Languages shown in the UI toggle. Irish (ga) is intentionally NOT listed:
 * its strings are unreviewed machine drafts and it stays hidden until a human
 * translation pass signs it off — see CLAUDE.md before re-adding it.
 */
