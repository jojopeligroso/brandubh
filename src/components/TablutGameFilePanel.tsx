// Tablut twin of ./GameFilePanel.tsx — same shape, wired to game/tablut/gameFile's
// codec (format tag "tablut-1", files a–i, ranks 1–9) and game/tablut/variants’s
// TablutRuleSet rather than Brandubh’s. See docs/design/game-import-export.md and
...
import {
  ...
  type ParseErrorCode,
  type ParsedGame,
} from "../game/tablut/gameFile";
import type { GameState } from "../game/tablut/types";
import type { TablutRuleSet as RuleSet } from "../game/tablut/variants";
...
export default function TablutGameFilePanel({
  t,
  state,
  rules,
  meta,
  ...
  return (
    <details
      ...
      data-testid={placement === "modal" ? "tablut-gamefile-panel-modal" : "tablut-gamefile-panel"}
