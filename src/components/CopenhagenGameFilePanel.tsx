// Copenhagen twin of ./GameFilePanel.tsx — same shape, wired to game/copenhagen/gameFile's
// codec (format tag "copenhagen-1", files a–k, ranks 1–11) and game/copenhagen/variants’s
// CopenhagenRuleSet rather than Brandubh’s. See docs/design/game-import-export.md and
// ADR-0006/0007 for why this is a fork rather than a generic component: the two
// panels share every string and every interaction, but GameState/RuleSet differ
// by board, and this project forks per board rather than parameterising.
...
import {
  ...
  type ParseErrorCode,
  type ParsedGame,
} from "../game/copenhagen/gameFile";
import type { GameState } from "../game/copenhagen/types";
import type { CopenhagenRuleSet as RuleSet } from "../game/copenhagen/variants";
...
export default function CopenhagenGameFilePanel({
  t,
  state,
  rules,
  meta,
  ...
  return (
    <details
      ...
      data-testid={placement === "modal" ? "copenhagen-gamefile-panel-modal" : "copenhagen-gamefile-panel"}
